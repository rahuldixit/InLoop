...
var DataReader = /** @class */ (function () {
    ...
    DataReader.prototype.parseFile = function (fileName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        Log_1.Log("pop\n");
                        return [4 /*yield*/, this.workBook.xlsx.readFile(fileName)];
                    case 1:
                        _a.sent();
                        //   .then( (x)=> {
                        //   Log('#');
    ...
    DataReader.prototype.getData = function (workSheetName, columnName, testCaseId) {
